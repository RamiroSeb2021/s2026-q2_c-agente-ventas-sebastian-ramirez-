...
Patterns tailored for this project or copied into the repository for local agent workflows:

| Skill | Description |
|-------|-------------|
| `create-agents-md` | Create or rewrite repository `AGENTS.md` guidance |
...
- [Repository AGENTS.md](../AGENTS.md) - AI agent general rules
