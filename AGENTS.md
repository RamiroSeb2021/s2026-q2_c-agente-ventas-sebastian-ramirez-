...
- This repo currently contains project-local Pi/agent configuration, documentation scaffolding, and one local skill.
- There is no verified runnable application code yet.
- There is no verified `README.md`, `pyproject.toml`, `uv.lock`, Python environment file, database seed file, Streamlit app, Dockerfile, compose file, or test suite yet.
...
.pi/settings.json                 Project Pi settings, including local skill paths
docs/skill-style-guide.md         Skill documentation/reference
skills/create-agents-md/SKILL.md  Local skill for creating AGENTS.md
```
...
No app runtime, uv command, Docker command, test command, or package install command is verified yet.
